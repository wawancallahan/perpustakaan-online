                        ...
                        <tbody>
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->siswa->nis }}/{{ $item->siswa->name }}</td>
                                    <td>{!! $item->keterlambatan !!}</td>
                                    <td>{!! $item->denda !!}</td>
                                    <td>{!! $item->status_formatted !!}</td>
                                    <td>
                                        <button type="button" data-link="{{ route('admin.transaction.return-book', $item->id) }}" class="btn btn-primary btn-sm kembalikan"> <i class="fa fa-location-arrow"></i> Kembalikan</button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
